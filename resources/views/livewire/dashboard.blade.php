    ...
    <div class="flex flex-col min-h-[calc(100vh-100px)] justify-between mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div class="flex flex-col items-start w-full space-y-2">
            <textarea  wire:model.debounce.500ms="question"
                class="w-full @error('question') border-red-500 @else border-gray-300 dark:border-gray-700 @enderror dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500
            ...
            <x-primary-button class="inline-flex flex-row items-center gap-2" x-on:click="genereteReport()">
                Gerar relatorio
